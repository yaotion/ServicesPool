...
namespace TF.Windows.QZServer
{
	...
	public class Configuration
	{
        ...
        private const string DefaultServiceName = "TF.Windows.QZServer.exe";
		private const string DefaultServiceDisplayName = "郑州畅想自动运行服务";
		private const string DefaultServiceDescription = "用于后台自动同步数据，计算数据，处理业务等";
